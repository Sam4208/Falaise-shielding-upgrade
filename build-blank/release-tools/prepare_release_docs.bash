...
buildDoxygenOutputDir="/sps/nemo/scratch/spratt/Falaise_testing/special_falaise/special-falaise/build-blank/BuildProducts/share/Falaise-5.1.6/Documentation/API"/html
buildDoxygenTagFile="/sps/nemo/scratch/spratt/Falaise_testing/special_falaise/special-falaise/build-blank/BuildProducts/share/Falaise-5.1.6/Documentation/API"/falaise.doxy.tag
...
onlineDoxygenOutputDir="/sps/nemo/scratch/spratt/Falaise_testing/special_falaise/special-falaise/build-blank/online_html"
...
for fix_file in $fixupBayeuxFiles ; do
  ...
  sed -i.bak -e "s#/sps/nemo/scratch/spratt/Falaise_testing/special_falaise/special-falaise/build-blank/##g;s#/sps/nemo/scratch/spratt/Falaise_testing/special_falaise/special-falaise/##g" $fix_file
  rm -f ${fix_file}.bak
done
