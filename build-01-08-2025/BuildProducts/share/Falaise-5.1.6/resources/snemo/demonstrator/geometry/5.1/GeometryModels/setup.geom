...
[name="experimental_hall.model" type="geomtools::simple_shaped_model"]
  ...
  #@variant_if geometry:layout/if_basic|true
    ...
    #@variant_if geometry:layout/if_basic/shielding/is_present|false
      ...
      mapping.daughter_id.iron_wall_it   : string = "[external_shield:side=15]"
      mapping.daughter_id.support_frame_it   : string = "[external_shield:side=16]"
      ...
      mapping.daughter_id.floor_polyethene   : string = "[external_shield:side=20]"
      mapping.daughter_id.iron_wall_mo   : string = "[external_shield:side=21]"
