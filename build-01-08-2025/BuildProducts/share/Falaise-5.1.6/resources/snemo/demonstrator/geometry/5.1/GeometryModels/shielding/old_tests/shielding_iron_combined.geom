...
[name="shielding_combined.model"  type="geomtools::simple_shaped_model"]
  ...
  material.ref : string = "lab_air"
      ...
      mapping.daughter_id.wall_italy   : string = "[external_shield:side=0]"
      mapping.daughter_id.wall_france   : string = "[external_shield:side=1]"
      mapping.daughter_id.wall_tunnel   : string = "[external_shield:side=2]"
      mapping.daughter_id.wall_mountain   : string = "[external_shield:side=3]"
