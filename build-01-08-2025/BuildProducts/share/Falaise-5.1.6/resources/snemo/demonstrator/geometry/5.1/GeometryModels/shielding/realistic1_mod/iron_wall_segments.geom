...
[name="art_mo_tu.model" type="geomtools::simple_boxed_model"]
  #@config Left-Right shielding wall
  shape_type : string = "box"
    x : real as length = 3.0 mm
    y : real as length = 2790 mm
    z : real as length = 7490 mm
  material.ref : string = "basic::polyethelene"
  visibility.hidden           : boolean = false
  visibility.hidden_envelope  : boolean = false
  visibility.daughters.hidden : boolean = false
  visibility.color            : string  = "pink"



[name="art_fr_it.model" type="geomtools::simple_boxed_model"]
  #@config Left-Right shielding wall
  shape_type : string = "box"
    x : real as length = 4590 mm
    y : real as length = 3 mm
    z : real as length = 7490 mm
  material.ref : string = "basic::polyethelene"
  visibility.hidden           : boolean = false
  visibility.hidden_envelope  : boolean = false
...
[name="art_ce_fl.model" type="geomtools::simple_boxed_model"]
  #@config Left-Right shielding wall
  shape_type : string = "box"
    x : real as length = 4590 mm
    y : real as length = 2790 mm
    z : real as length = 3 mm
  material.ref : string = "basic::polyethelene"
  visibility.hidden           : boolean = false
  visibility.hidden_envelope  : boolean = false
  visibility.daughters.hidden : boolean = false
