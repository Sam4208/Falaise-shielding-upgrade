...
[name="experimental_hall.model" type="geomtools::simple_shaped_model"]
  ...
  #@variant_if geometry:layout/if_basic|true
    ...
    #@variant_if geometry:layout/if_basic/shielding/is_present|false
      ...
      internal_item.placement.support_frame_it : string = "3080 0 +782 (mm) "
    
      internal_item.model.support_frame_fr     : string = "support_frame_fr_it.model"
      internal_item.placement.support_frame_fr : string = "-2217 0 +782 (mm) "



      mapping.daughter_id.support_frame_it   : string = "[external_shield:side=0]"
      mapping.daughter_id.support_frame_fr   : string = "[external_shield:side=1]"
      ...
      internal_item.placement.iron_wall_it : string = "1730 0 +782 (mm) / y 180 (degree)"
      internal_item.model.support_frame_it     : string = "support_frame_fr_it.model"
      internal_item.placement.support_frame_it : string = "3080 0 +782 (mm) "
      internal_item.model.iron_wall_fr     : string = "shielding_wall_fr_it.model"
      internal_item.placement.iron_wall_fr : string = "-1730 0 +782 / y 180 (degree) "
      internal_item.model.support_frame_fr     : string = "support_frame_fr_it.model"
      internal_item.placement.support_frame_fr : string = "-2217 0 +782 (mm) "
      internal_item.model.floor_iron     : string = "shielding_floor_iron.model"
      internal_item.placement.floor_iron : string = "0 0 -2177.5 (mm) "
      internal_item.model.iron_wall_mo     : string = "tu_mo_block.model"
      internal_item.placement.iron_wall_mo : string = "0 4365 +782 (mm) / x 180 (degree)"
      internal_item.model.iron_wall_tu     : string = "tu_mo_block.model"
      internal_item.placement.iron_wall_tu : string = "0 -4365 +782 (mm) "
      internal_item.model.ceiling_iron  : string = "shielding_ceiling_iron.model"
      internal_item.placement.ceiling_iron : string = "0 0 3941 (mm) "
      ...
      internal_item.placement.water_wall_it : string = "2380 0 +950 (mm) "
      internal_item.model.water_wall_fr     : string = "water_wall_fr_.model"
      internal_item.placement.water_wall_fr : string = "-3049 0 +950 (mm) "
      internal_item.model.floor_polyethene     : string = "shielding_floor_polyethene.model"
      internal_item.placement.floor_polyethene : string = "0 0 -2407.5 (mm) "
      internal_item.model.water_wall_mo     : string = "tu_mo_polyethelene.model"
      internal_item.placement.water_wall_mo : string = "-330 4575 +782 (mm) "
      internal_item.model.water_wall_tu     : string = "tu_mo_polyethelene.model"
      internal_item.placement.water_wall_tu : string = "-330 -4575 +782 (mm) "
      internal_item.model.ceiling_polyethelene  : string = "shielding_ceiling_polyethelene.model"
      internal_item.placement.ceiling_polyethelene : string = "-330 0 4161 (mm) "

      internal_item.model.jerry_can_it_1_  : string = "jerry_can_it.model"
      internal_item.placement.jerry_can_it_1_ : string = "2680 0 -2068 (mm) "
      internal_item.model.jerry_can_it_2_  : string = "jerry_can_it.model"
      internal_item.placement.jerry_can_it_2_ : string = "2080 0 -2068 (mm) "
      internal_item.model.jerry_can_fr_  : string = "jerry_can_fr.model"
      internal_item.placement.jerry_can_fr_ : string = "-2674 0 -2068 (mm) "
      ...
      internal_item.model.iron_wall_it     : string = "shielding_wall_fr_it.model"
      internal_item.placement.iron_wall_it : string = "1730 0 +782 (mm) "
      internal_item.model.water_wall_it     : string = "water_wall_it_.model"
      internal_item.placement.water_wall_it : string = "2380 0 +782 (mm) "
      internal_item.model.support_frame_it     : string = "support_frame_fr_it.model"
      internal_item.placement.support_frame_it : string = "3080 0 +782 (mm) "
      ...
      internal_item.placement.support_frame_fr : string = "-2217 0 +782 (mm) "
      internal_item.model.water_wall_fr     : string = "water_wall_fr_.model"
      internal_item.placement.water_wall_fr : string = "-3049 0 +782 (mm) "

      internal_item.model.floor_iron     : string = "shielding_floor_iron.model"
      internal_item.placement.floor_iron : string = "0 0 -2177.5 (mm) "
      internal_item.model.floor_polyethene     : string = "shielding_floor_polyethene.model"
      internal_item.placement.floor_polyethene : string = "0 0 -2461 (mm) "

      internal_item.model.iron_wall_mo     : string = "tu_mo_block.model"
      internal_item.placement.iron_wall_mo : string = "0 4335 782 (mm)"
      internal_item.model.water_wall_mo     : string = "tu_mo_polyethelene.model"
      internal_item.placement.water_wall_mo : string = "0 4515 782 (mm) "

      internal_item.model.iron_wall_tu     : string = "tu_mo_block.model"
      internal_item.placement.iron_wall_tu : string = "0 -4335 782 (mm)"
      internal_item.model.water_wall_tu     : string = "tu_mo_polyethelene.model"
      internal_item.placement.water_wall_tu : string = "0 -4515 782 (mm) "

      internal_item.model.ceiling_iron  : string = "shielding_ceiling_iron.model"
      internal_item.placement.ceiling_iron : string = "0 0 4001 (mm) "
      internal_item.model.ceiling_polyethelene  : string = "shielding_ceiling_polyethelene.model"
      internal_item.placement.ceiling_polyethelene : string = "0 0 4301 (mm) "
      ...
      internal_item.placement.water_wall_fr : string = "-3049 0 -718 (mm) "
  ...
  internal_item.model.support     : string = "support_frame_model.model"
  internal_item.placement.support : string = "0 0 0 (mm)"

  internal_item.model.iron     : string = "iron_shielding_model.model"
  internal_item.placement.iron : string = "0 0 0 (mm)"

  internal_item.model.water     : string = "water_model.model"
  internal_item.placement.water : string = "0 0 0 (mm)"
  
  internal_item.model.full     : string = "shielding_model_combined.model"
  internal_item.placement.full : string = "0 0 0 (mm)"

  mapping.daughter_id.full   : string = "[external_shield:side=0]"
  mapping.daughter_id.support   : string = "[external_shield:side=1]"
  mapping.daughter_id.iron   : string = "[external_shield:side=2]"
  mapping.daughter_id.water   : string = "[external_shield:side=3]"
